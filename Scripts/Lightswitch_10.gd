...
@onready var light1 = $"../WorldEnvironment/Light22"
@onready var light2 = $"../WorldEnvironment/Light23"
@onready var light3 = $"../WorldEnvironment/Light24"
@onready var light4 = $"../WorldEnvironment/Light25"
